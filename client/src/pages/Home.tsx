      ...
      <main id="top">
        ...
        <section id="work" className="work section-pad section-ink">
          ...
          <div className="project-card">
            ...
            <div className="project-image project-prototype"><div className="image-annotation"><span>CHATNP / PROTOTYPE</span><span>NP1 MONI</span></div><div className="prototype-window"><aside className="prototype-rail"><a href="https://karktech.tech" target="_blank" rel="noreferrer" className="prototype-back">← KarkTech</a><button className="prototype-new">＋ New Chat</button><span className="prototype-label">Recent chats</span><span className="prototype-history">□ Explain quantum computing...</span><span className="prototype-history">□ Nepali agriculture tips</span><span className="prototype-settings">◌ Settings</span></aside><div className="prototype-main"><div className="prototype-topbar"><span><b>NP</b> ChatNP <small>v1.0</small></span><em>NP1 MONI · <i>Coming Soon</i></em></div><div className="prototype-message"><b>NP</b><span>Namaste! I am ChatNP, developed by KarkTech. How can I help you today?</span></div><div className="prototype-suggestions"><span>Give me tips for tomato farming in Nepal</span><span>Write a polite business email</span><span>Explain Newton&apos;s laws simply</span></div><div className="prototype-input">Message ChatNP... <b>↗</b></div><small className="prototype-note">ChatNP can make mistakes. Verify important information.</small></div></div><span className="image-label">A useful AI, closer to home ↗</span></div>
          </div>
